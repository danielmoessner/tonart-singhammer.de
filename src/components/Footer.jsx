...
function Component() {
  ...
  return (
    <footer className="bg-adobe-2" aria-labelledby="footerHeading">
      ...
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
        ...
        <div className="mt-12 border-t border-orange-100 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
          <div className="flex space-x-6 md:order-2">
            {footerNavigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-orange-100 hover:text-orange-050">
                <span className="sr-only">{item.name}</span>
                <item.icon className="h-6 w-6" aria-hidden="true" />
              </a>
            ))}
          </div>
          <p className="mt-8 text-base text-orange-100 md:mt-0 md:order-1">
