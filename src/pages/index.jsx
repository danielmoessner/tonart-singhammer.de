      ...
      <>
        ...
        <div className="bg-white">
          ...
          <main>
              ...
              <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                  <div className="absolute inset-0">
                    ...
                    />
                    <div
                      className="absolute inset-0 bg-gradient-to-r from-yellow-700 to-yellow-900 opacity-100"
                      style={{ mixBlendMode: 'multiply' }}
                    />
                  </div>
                  <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                      <span className="block text-white">Tonarbeiten und</span>
                      <span className="block text-yellow-200">Erinnerungsgefäße</span>
                    </h1>
                    ...
                    <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                      <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                        <a
                          href="/"
                          className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-yellow-700 bg-white hover:bg-yellow-050 sm:px-8"
                        >
                          Get started
                        </a>
                        <a
            ...
            <div className="relative pt-16 pb-32 overflow-hidden bg-gradient-to-b from-yellow-200 to-yellow-050">
              ...
              <div className="relative">
                <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                  <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                    <div>
                      <div className="mt-6">
                        <h2 className="text-3xl font-extrabold tracking-tight text-yellow-900">
                          Über mich
                        </h2>
                        ...
                        <div className="mt-6">
                          <a
                            href="/"
                            className="inline-flex px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-red-600 to-red-600 hover:from-red-700 hover:to-red-700"
                          >
                            Mehr erfahren
                          </a>
                        </div>
                    ...
                    <div>
                      <div className="mt-6">
                        ...
                        <div className="mt-6">
                          <a
                            href="/"
                            className="inline-flex px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-orange-700 to-orange-700 hover:from-red-700 hover:to-yellow-700"
                          >
                            Get started
                          </a>
                        </div>
            ...
            {/* Stats section */}
            <div className="relative bg-orange-800">
              ...
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-16">
                <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-2 xl:pb-24">
                  ...
                  <p className="mt-3 text-3xl font-extrabold text-white">Was ist demnächst los?</p>
                    ...
                    {metrics.map((item) => (
                      <p key={item.id}>
                        ...
                        <span className="mt-1 block text-base text-gray-100">
                          <span className="font-medium text-white">10.4.2021</span> Wir beschäftigen
                          uns mit unterschiedlichen Töpfertechniken und probieren diese aus.
                        </span>
                      </p>
                    ))}
                  </div>
                ...
                <div className="h-full w-full xl:grid xl:grid-cols-2">
                  <div className="h-full xl:relative xl:col-start-2">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1572982758354-c097406beae5?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2830&q=80&sat=-100"
                      alt="People working on laptops"
                    />
                    <div
                      aria-hidden="true"
          ...
          <footer className="bg-yellow-050" aria-labelledby="footerHeading">
                ...
                <div className="mt-12 xl:mt-0">
                  ...
                  <form className="mt-4 sm:flex sm:max-w-md">
                    ...
                    <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                      <button
                        type="submit"
                        className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-red-600 to-yellow-600 hover:from-red-700 hover:to-yellow-700"
                      >
                        Subscribe
                      </button>
                    </div>
